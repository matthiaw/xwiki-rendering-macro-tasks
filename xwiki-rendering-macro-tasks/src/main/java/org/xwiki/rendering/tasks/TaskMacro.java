...
public class TaskMacro extends AbstractMacro<TaskMacroParameters> {
	 ...
	 */
	private static final String DESCRIPTION = "Task Macro";
	 ...
	 */
	public TaskMacro() {
		super(Task.CLASS, DESCRIPTION, TaskMacroParameters.class);
	}
...
//		String macroContent = "<span id=\"task-editor-" + parameters.getGuid() + "\" style=\"display: none\">" +"FORM of Task: "+content+ "</span>";
//		return this.contentParser.parse(macroContent, context, true, context.isInline()).getChildren();
